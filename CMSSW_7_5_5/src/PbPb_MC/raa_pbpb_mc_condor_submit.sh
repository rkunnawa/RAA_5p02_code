...
do
    ...
    outfile="PbPb_MC_5p02TeV_ak${algo}${radius}${jetType}_20_eta_20_${endfile}.root"
...
#+IsMadgraph = 1
Arguments      = $startfile $endfile $radius $algo $jetType $outfile
...
transfer_input_files = $tardir/jetRAA_run_PbPb_MC.tar
